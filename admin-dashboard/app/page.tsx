...
/** شعار TikTok (غير متوفر في lucide كعلامة تجارية) */
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                {(contact.instagram || contact.twitter || contact.tiktok || contact.snapchat) && (
                  <div className="bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20 hover:bg-white/20 transition-all group">
                    <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all shadow-xl">
                    ...
                    <div className="space-y-2 text-white/90">
                      ...
                      {contact.tiktok && (
                        <p className="flex items-center gap-2">
                          <TikTokBrandIcon className="w-4 h-4 shrink-0" />
                          <span className="break-all">{contact.tiktok}</span>
                        </p>
                      )}
                      {contact.snapchat && (
                        <p className="flex items-center gap-2">
                          <Ghost className="w-4 h-4 shrink-0" strokeWidth={2} />
                          <span className="break-all">{contact.snapchat}</span>
                        </p>
                      )}
                    </div>
                  </div>
