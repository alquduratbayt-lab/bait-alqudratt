...
const userTypes = ['طالب', 'ولي الأمر'];
const problemTypes = [
  ...
  const loadUserData = async () => {
    try {
      ...
      if (userData) {
        ...
        setUserType(userData.type === 'parent' ? 'ولي الأمر' : 'طالب');
        console.log('Set name:', userData.name, 'phone:', userData.phone, 'type:', userData.type);
      }
    } catch (error) {
